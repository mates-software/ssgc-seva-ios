...
class SpatialDataContext: NSObject, SpatialDataProtocol {
    ...
    private let networkQueue = DispatchQueue(label: "services.seva.spatialdata.network", qos: .utility)
    private var dispatchQueue = DispatchQueue(label: "services.seva.spatialdata", qos: .utility, attributes: .concurrent)
