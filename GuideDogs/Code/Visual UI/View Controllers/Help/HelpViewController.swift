...
class HelpViewController: BaseTableViewController {
    ...
    private var helpPages = [
        ...
        FAQListHelpPage(title: GDLocalizedString("faq.title"),
                        sections: [FAQSection(heading: GDLocalizedString("faq.section.what_is_Seva"),
                                              faqs: [FAQ(GDLocalizedString("faq.when_to_use_Seva.question"), GDLocalizedString("faq.when_to_use_Seva.answer")),
                                   ...
                                   FAQSection(heading: GDLocalizedString("faq.section.how_seva_works"),
